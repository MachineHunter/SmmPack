...
void ShiftAddrOfHeaders(PE* pe, UCHAR* lpTargetBinBuffer, UINT* sizeIncrease, WCHAR* lpTargetFilename) {
	...
	// shift protocol function addresses
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	ShiftAddrOfHeaders(pe, lpTargetBinBuffer, &sizeIncrease, lpTargetFilename);
