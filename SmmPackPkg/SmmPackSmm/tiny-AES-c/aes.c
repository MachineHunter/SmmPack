...
void AES_CBC_encrypt_buffer(struct AES_ctx *ctx, UINT8* buf, UINTN length)
{
  UINTN i;
  UINT8 *Iv = ctx->Iv;
...
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, UINT8* buf, UINTN length)
{
  UINTN i;
...
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, UINT8* buf, UINTN length)
{
